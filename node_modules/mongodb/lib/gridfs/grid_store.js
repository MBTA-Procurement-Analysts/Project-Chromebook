 ...
 * @property {number} chunkNumber The current chunk number.txt the gridstore has materialized into memory
 ...
 *
 * @method
 * @param {number} [length] the number.txt of characters to read. Reads all the characters from the read/write head to the EOF if not specified.
...
var writeBuffer = function(self, buffer, close, callback) {
  ...
  if(self.mode != "w") {
    ...
    if(self.currentChunk.position + buffer.length >= self.chunkSize) {
      ...
      // Total number.txt of chunks to write
 ...
 *        <pre><code>
 *        {
 *          '_id' : , // {number.txt} id for this file
 *          'filename' : , // {string} name for this file
 *          'contentType' : , // {string} mime type for this file
 *          'length' : , // {number.txt} size of this file?
 *          'chunksize' : , // {number.txt} chunk size used by this file
 *          'uploadDate' : , // {Date}
