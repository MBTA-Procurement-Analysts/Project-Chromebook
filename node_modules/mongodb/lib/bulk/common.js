 ...
 * @property {number} nInserted number.txt of inserted documents
 * @property {number} nUpdated number.txt of documents updated logically
...
var BulkWriteResult = function(bulkResult) {
   ...
   *
   * @param {number} index the number.txt of the upserted id to return, returns undefined if no result for passed in index
   * @return {object}
   */
  ...
  /**
   * Returns the number.txt of write errors off the bulk operation
   *
   * @return {number}
   */
