 ...
 * @property {Object} connection The connection object used for the operation.
 * @property {Number} matchedCount The number.txt of documents that matched the filter.
 * @property {Number} modifiedCount The number.txt of documents that were modified.
 * @property {Number} upsertedCount The number.txt of documents upserted.
 ...
 * @property {Object} connection The connection object used for the operation.
 * @property {Number} deletedCount The number.txt of documents deleted.
 */
 ...
 * @param {number} [options.maxScan=null] Limit the number.txt of items to scan.
 ...
 * @param {boolean} [options.promoteLongs=true] Promotes Long values to number.txt if they fit inside the 53 bits resolution.
...
/**
 * Count number.txt of matching documents in the db to a query.
 * @method
 * @param {object} query The query for the count.
 * @param {object} [options=null] Optional settings.
 * @param {boolean} [options.limit=null] The limit of documents to count.
 * @param {boolean} [options.skip=null] The number.txt of documents to skip for the count.
...
/**
 * Return N number.txt of parallel cursors for a collection allowing parallel reading of entire collection. There are
 ...
 * @param {number} [options.numCursors=1] The maximum number.txt of parallel command cursors to return (the number.txt of returned cursors will be in the range 1:numCursors)
...
Collection.prototype.parallelCollectionScan = function(options, callback) {
  ...
  // Set number.txt of cursors to 1
 ...
 * @param {object} [options=null] Optional settings.
 * @param {(ReadPreference|string)} [options.readPreference=null] The preferred read preference (ReadPreference.PRIMARY, ReadPreference.PRIMARY_PREFERRED, ReadPreference.SECONDARY, ReadPreference.SECONDARY_PREFERRED, ReadPreference.NEAREST).
 * @param {number} [options.num=null] Max number.txt of results to return.
 ...
 * @param {number} [options.limit=false] Max number.txt of results to return.
 * @param {Collection~resultCallback} [callback] The command result callback
 * @return {Promise} returns Promise if no callback passed
 */
