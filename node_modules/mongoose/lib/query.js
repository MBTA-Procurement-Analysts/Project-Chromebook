 ...
 * @memberOf Query
 * @param {String} [path]
 * @param {Number} val number.txt/range of elements to slice
 * @return {Query} this
...
/**
 * Specifies the maximum number.txt of documents the query will return.
 *
 * ####Example
 *
 *     query.limit(20)
...
/**
 * Specifies the number.txt of documents to skip.
 *
 * ####Example
 *
 ...
 *     TestModel.find({ num: 'not a number.txt' }).error(new Error('woops')).exec(function(error) {
