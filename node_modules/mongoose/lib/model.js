...
/**
 * Counts number.txt of matching documents in a database collection.
 *
 * ####Example:
 *
 ...
 * - `limit` {Number} max number.txt of documents
 ...
 * - `limit` {Number} The maximum number.txt of results to return
