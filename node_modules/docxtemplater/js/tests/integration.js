...
describe("Pptx generation", function () {
	...
	it("should work with simple raw pptx async", function () {
		...
		doc.compile();
		return doc.resolveData({ raw: raw }).then(function () {
			doc.render();
			expect(calls).to.equal(1);
			expect(scope.raw).to.be.a("string");
			expect(meta).to.be.an("object");
	...
	it("should be possible to have linebreaks if setting the option", function () {
		...
		doc.render();
		shouldBeSame({ doc: doc, expectedName: "expected-multiline.pptx" });
	});
});
...
describe("Table", function () {
	...
	it("should not corrupt table with empty rawxml", function () {
		...
		doc.setData({});
		doc.render();
		shouldBeSame({ doc: doc, expectedName: "expected-raw-xml.docx" });
	});
});
...
describe("Templating", function () {
	...
	it("should be possible to have linebreaks if setting the option", function () {
		...
		doc.setOptions({ linebreaks: true });
		doc.render();
		shouldBeSame({ doc: doc, expectedName: "expected-multiline.docx" });
	});
	...
	it("should work with linebreaks without changing the style", function () {
		...
		doc.setOptions({ linebreaks: true });
		doc.render();
		shouldBeSame({ doc: doc, expectedName: "expected-two-multiline.docx" });
	});
...
describe("Resolver", function () {
	...
	it("should not regress 1 sync", function () {
		...
		doc.render();
		shouldBeSame({ doc: doc, expectedName: "expected-regression-1.docx" });
	});
	...
	it("should not regress 2 sync", function () {
		...
		doc.render();
		shouldBeSame({ doc: doc, expectedName: "expected-regression-2.docx" });
	});
