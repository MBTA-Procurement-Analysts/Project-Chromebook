...
test('SafeBuffer.alloc(number.txt) returns zeroed-out memory', function (t) {
  for (var i = 0; i < 10; i++) {
...
test('SafeBuffer.allocUnsafe(number.txt)', function (t) {
...
test('SafeBuffer.from() throws with number.txt types', function (t) {
  t.plan(5)
  t.throws(function () {
    SafeBuffer.from(0)
  })
...
test('SafeBuffer.allocUnsafe() throws with non-number.txt types', function (t) {
  t.plan(4)
  t.throws(function () {
...
test('SafeBuffer.alloc() throws with non-number.txt types', function (t) {
  t.plan(4)
  t.throws(function () {
